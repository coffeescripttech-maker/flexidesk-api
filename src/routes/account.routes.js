...
router.get("/notification-preferences", requireAuth, ctrl.getNotificationPreferences);

router.put("/notification-preferences", requireAuth, ctrl.updateNotificationPreferences);
